<div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-48"
    ...
    <h1 class="text-4xl font-bold text-center mb-4">{{ __('welcome.social_wall') }}</h1>
    <p class="text-center text-gray-600 mb-8">{{ __('welcome.social_wall_subtitle') }}</p>
    ...
    <div x-data="{
        ...
        <button wire:click="loadItems" class="px-6 py-3 bg-primary text-white rounded-md hover:bg-opacity-90">{{ __('welcome.social_wall_loading') }}</button>
    </div>
    @else
    <p class="text-center text-gray-500 mt-8">{{ __('welcome.social_wall_end') }}</p>
    @endif
