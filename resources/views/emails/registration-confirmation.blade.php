...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
    ...
    @php
        ...
        $primaryColor = '#00554E';
        $appName = $organizer->name ?? config('app.name');
    @endphp
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; margin: 20px auto; border: 1px solid #cccccc; background-color: #ffffff;">
        {{-- Header --}}
        <tr>
            <td align="center" style="padding: 40px 0 30px 0; background-color: {{ $primaryColor }}; color: #ffffff;">
                @if($organizer && $organizer->logo_path)
                    <img src="{{ $message->embed(public_path('storage/' . $organizer->logo_path)) }}" alt="{{ $appName }}" height="60" style="margin-bottom: 20px;">
                @endif
        ...
        <tr>
            <td style="padding: 40px 30px 40px 30px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #eeeeee; border-bottom: 1px solid #eeeeee;">
                                <tr>
                                    <td style="padding: 15px 0;">
                                        <b style="color: {{ $primaryColor }};">Event Name:</b><br>
                                        {{ $registration->event->name }}
                                    </td>
                                </tr>
                                <tr>
                                    <<td style="padding: 15px 0;">
                                        <b style="color: {{ $primaryColor }};">Date & Time:</b><br>
                    ...
                    <tr>
                        <td style="padding: 15px 0;">
                            <b style="color: {{ $primaryColor }};">Lokasi:</b><br>
                    ...
                    <tr>
                        <td style="padding: 15px 0; font-size: 14px; line-height: 1.5;">
                            <b style="color: {{ $primaryColor }};">Informasi Acara Online:</b><br>
        ...
        <tr>
            <td align="center">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" bgcolor="{{ $primaryColor }}" style="border-radius: 5px;">
