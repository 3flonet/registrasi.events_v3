...
<div x-data="{
    ...
    <button
        ...
        class="fixed z-[10000] left-1/2 -translate-x-1/2 transform md:-translate-y-1/2 md:translate-x-0 w-10 h-10 bg-gray-800 text-white flex items-center justify-center shadow-lg hover:bg-gray-700 transition-all duration-300 ease-in-out rounded-full"
