...
<div class="bg-gray-50 py-12">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{{ __('welcome.popular_news') }}</h2>
            <p class="mt-2 text-lg leading-8 text-gray-600">{{ __('welcome.stay_updated_news') }}</p>
        </div>
