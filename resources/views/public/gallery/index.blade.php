                ...
                <div class="p-6 md:p-8 text-gray-900">
                                    ...
                                    <div class="relative h-64 bg-gray-100 overflow-hidden">
                                        ...
                                        @else
                                            <div class="w-full h-full flex flex-col items-center justify-center text-gray-400">
                                                ...
                                                <span class="text-xs uppercase tracking-wider font-semibold">{{ __('welcome.gallery_empty_album') }}</span>
                                            </div>
                                        @endif
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="flex items-center justify-between text-sm text-gray-500">
                                            <span class="flex items-center">
                                                ...
                                                {{ __('welcome.gallery_photos_count', ['count' => $photoCount]) }}
                                            </span>
                    ...
                    @else
                        ...
                        <div class="flex flex-col items-center justify-center py-20 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300 text-center">
                            ...
                            <h3 class="text-lg font-medium text-gray-900">{{ __('welcome.gallery_no_albums') }}</h3>
                            <p class="text-gray-500 max-w-sm mt-1">{{ __('welcome.gallery_no_albums_desc') }}</p>
                        </div>
                    @endif
