<x-guest-layout>
    ...
    <div class="w-full">
        ...
        <div class="bg-gray-100 pt-36 pb-8">
            <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                ">
                            ...
                            <div class="flex justify-between items-center gap-x-4 gap-y-2 mb-4">
                                <h2 class="text-2xl font-bold font-serif text-gray-800">{{ __('welcome.featured_post') }}</h2>
                                <a href="{{ route('news.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800 transition-colors">
                                    &larr; {{ __('welcome.news_back_all') }}
                                </a>
                            </div>
                            @endif
                        ...
                        <div class="p-6 md:p-10">
                            ...
                            <div class="mt-8 text-gray-800 leading-relaxed text-lg">
                                ...
                                <div class="bg-gray-100 border-l-4 border-indigo-500 p-6 rounded-lg text-center">
                                    <h3 class="text-xl font-semibold mb-3">{{ __('welcome.news_press_release_doc') }}</h3>
                                    <p class="text-gray-700 mb-4">
                                        {{ __('welcome.news_press_release_desc') }}
                                    </p>
                                    <a href="{{ $documentUrl }}"
                                        target="_blank"
                                        download
                                        ...
                                        {{ __('welcome.news_download_doc') }}
                                    </a>
                                </div>
                                @else
                                <div class="bg-red-100 border-l-4 border-red-500 p-6 rounded-lg text-center">
                                    <p class="text-red-700">{{ __('welcome.news_press_release_not_found') }}</p>
                                </div>
                                @endif
                                ...
                                <div class="mt-8 pt-6 border-t border-gray-200"> {{-- Pemisah --}}
                                    <div class="bg-gray-100 border-l-4 border-indigo-500 p-6 rounded-lg text-center">
                                        <h3 class="text-xl font-semibold mb-3">{{ __('welcome.news_policy_doc') }}</h3>
                                        <p class="text-gray-700 mb-4">
                                            {{ __('welcome.news_policy_desc') }}
                                        </p>
                                        <a href="{{ $documentUrl }}"
                                            target="_blank"
                                            download
                            ...
                            <div class="mt-12 pt-8 border-t border-gray-200">
                                <h3 class="text-2xl font-bold font-serif mb-6">{{ __('welcome.news_leave_comment') }}</h3>
                                <form class="space-y-4">
                                    <div>
                                        <label for="comment_name" class="sr-only">Name</label>
                                        <input type="text" id="comment_name" placeholder="{{ __('welcome.news_comment_name') }}" class="w-full px-4 py-2 border rounded-md">
                                    </div>
                                    <div>
                                        <label for="comment_email" class="sr-only">Email</label>
                                        <input type="email" id="comment_email" placeholder="{{ __('welcome.news_comment_email') }}" class="w-full px-4 py-2 border rounded-md">
                                    </div>
                                    <div>
                                        <label for="comment_message" class="sr-only">Comment</label>
                                        <textarea id="comment_message" rows="5" placeholder="{{ __('welcome.news_comment_body') }}" class="w-full px-4 py-2 border rounded-md"></textarea>
                                    </div>
                                    <button type="submit" class="bg-indigo-600 text-white px-6 py-2 rounded-md hover:bg-indigo-700">{{ __('welcome.news_comment_post') }}</button>
                                </form>
                            </div>
                            ...
                            <div class="mt-12 pt-8 border-t border-gray-200">
                                <h3 class="text-2xl font-bold font-serif mb-6">{{ __('welcome.news_also_like') }}</h3>
