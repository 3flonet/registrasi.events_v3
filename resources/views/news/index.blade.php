    ...
    <div class="w-full">
        ...
        <div class="bg-gray-50 py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <div>
                            <h1 class="text-3xl font-bold font-serif mb-2">
                                {{ __('welcome.news_category') }}: {{ $currentCategory->getTranslation('name', $locale) }}
                            </h1>
                            <p class="text-lg text-gray-600">
                                {{ __('welcome.news_showing_all_category') }}
                            </p>
                        </div>
                        ...
                        <a href="{{ route('news.index') }}" class="px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 transition-colors">
                            {{ __('welcome.news_view_all_news') }} &rarr;
                        </a>
                    </div>
                </section>
                ...
                <section class="mb-12">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="md-col-span-3 text-center py-12">
                            <p class="text-xl text-gray-500">{{ __('welcome.news_no_posts') }}</p>
                        </div>
                        @endforelse
                    </div>
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold font-serif mb-6">{{ __('welcome.news_latest') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
