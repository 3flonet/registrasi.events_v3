...
class Event extends Model implements HasMedia
{
    ...
    protected function remainingQuota(): Attribute
    {
        return Attribute::make(
            get: fn() => $this->quota - $this->registrations()->where('payment_status', 'paid')->count(),
        );
    }
    ...
    {
        return $this->belongsTo(EventEmailTemplate::class, 'reminder_template_id');
    }

    public function certificateTemplate()
    {
        return $this->belongsTo(EventEmailTemplate::class, 'certificate_template_id');
    }

    public function feedbackTemplate()
    {
        return $this->belongsTo(EventEmailTemplate::class, 'feedback_template_id');
    }
    ...
    public function sessionGroups(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(EventSessionGroup::class)->orderBy('id', 'asc');
    }

    public function sessions(): \Illuminate\Database\Eloquent\Relations\HasManyThrough
    {
        return $this->hasManyThrough(EventSession::class, EventSessionGroup::class);
    }

    public function agendas(): \Illuminate\Database\Eloquent\Relations\BelongsToMany
    {
        return $this->belongsToMany(EventAgenda::class, 'event_agenda_event');
    }
}
