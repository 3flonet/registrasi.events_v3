...
class Index extends Component
{
    ...
    public $event_id; // Specific event scoping
    ...
    public function render()
    {
        ...
        $events = \App\Models\Event::where('is_paid_event', true)->latest()->get();
    ...
    public function edit($id)
    {
        ...
        $this->event_id = $voucher->event_id;
    ...
    {
        $this->reset(['voucherId', 'code', 'type', 'amount', 'min_purchase_amount', 'usage_limit', 'usage_per_user', 'valid_from', 'valid_until', 'is_active', 'event_id']);
    }
}
