...
class NewRegistrationNotification extends Notification implements ShouldBroadcast, ShouldQueue
{
    use Queueable;
    ...
    {
        // Kirim notifikasi via email, simpan ke database, DAN broadcast real-time
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'event_name' => $this->registration->event->getTranslation('name', 'en'),
